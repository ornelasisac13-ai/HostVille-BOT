...
// ================= REGISTRO DE TODOS COMANDOS (ÚNICO) ====================
/* Já feito na Parte 2 dentro do interactionCreate, evitando duplicação */
...
// Remove warnings duplicados do Node (ephemeral, ready, depreciação)
process.removeAllListeners("warning"); 
console.warn = (...args) => {};

// Ignora warnings específicos do npm (npm WARN config production)
